        ...
        do {
            ...
            switch (pilihanMenu) {
                case 1:
                    ...
                    input.nextLine(); // clear buffer
                    System.out.print("Kategori (1: Anime, 2: Game): ");
                    int kategori = input.nextInt();
                    KostumCosplay kostumBaru;
                    if (kategori == 1) {
                        kostumBaru = new KostumAnime(idKostum, namaKostum, harga, "Anime");
                    } else if (kategori == 2) {
                        kostumBaru = new KostumGame(idKostum, namaKostum, harga, "Anime");
                    } else {
